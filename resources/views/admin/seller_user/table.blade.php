       ...
       <div class="col-lg-12">
           <div class="card shadow-sm border-0 rounded">
               ...
               <div class="card-header bg-primary  d-flex justify-content-between align-items-center">
                   <h5 class="mb-0 text-white">All Seller Users</h5>
                   <a href="{{ route('admin.seller-user.create') }}" class="btn btn-light btn-sm">
                       <i class="bi bi-plus-circle"></i> Add Seller User
                   </a>
               </div>
